...
public class StudyFixtures {
    ...
    public static final StudyPlanner 자바_스터디_계획 = new StudyPlanner(LocalDate.now().plusMonths(1), LocalDate.now().plusMonths(2), PREPARE);
    ...
    public static final Study 자바_스터디 = new Study(자바_스터디_내용, 자바_스터디_참가자들, 자바_스터디_태그, LocalDateTime.now(),
            10, LocalDate.now(), LocalDate.now().plusMonths(1), LocalDate.now().plusMonths(2));

    public static Study 자바_스터디(final Long ownerId, final Set<Long> participants) {
        return new Study(자바_스터디_내용, new Participants(ownerId, participants), 자바_스터디_태그, LocalDateTime.now(),
                10, LocalDate.now(), LocalDate.now().plusMonths(1), LocalDate.now().plusMonths(2));
    }
    ...
    public static final Study 리액트_스터디 = new Study(리액트_스터디_내용, 리액트_스터디_참가자들, 리액트_스터디_태그,
            LocalDateTime.now(), 5, LocalDate.now(),
    ...
    public static Study 리액트_스터디(final Long ownerId, final Set<Long> participants) {
        return new Study(리액트_스터디_내용, new Participants(ownerId, participants), 리액트_스터디_태그,
                LocalDateTime.now(), 5, LocalDate.now(),
                LocalDate.now().plusMonths(1), LocalDate.now().plusMonths(2));
    }
    ...
    public static final Study 자바스크립트_스터디 = new Study(자바스크립트_스터디_내용, 자바스크립트_스터디_참가자들, 자바스크립트_스터디_태그,
            LocalDateTime.now(), 20, LocalDate.now(), LocalDate.now().plusMonths(1),
            LocalDate.now().plusMonths(2));

    public static Study 자바스크립트_스터디(final Long ownerId, final Set<Long> participants) {
        return new Study(자바스크립트_스터디_내용, new Participants(ownerId, participants), 자바스크립트_스터디_태그,
                LocalDateTime.now(), 20, LocalDate.now(), LocalDate.now().plusMonths(1),
                LocalDate.now().plusMonths(2));
    }
    ...
    public static final Study HTTP_스터디 = new Study(HTTP_스터디_내용, HTTP_스터디_참가자들, HTTP_스터디_태그, LocalDateTime.now(),
            4, LocalDate.now(), LocalDate.now().plusMonths(1), LocalDate.now().plusMonths(2));

    public static Study HTTP_스터디(final Long ownerId, final Set<Long> participants) {
        return new Study(HTTP_스터디_내용, new Participants(ownerId, participants), HTTP_스터디_태그, LocalDateTime.now(), 4,
                LocalDate.now(), LocalDate.now().plusMonths(1), LocalDate.now().plusMonths(2));
    }
    ...
    public static final Study 알고리즘_스터디 = new Study(알고리즘_스터디_내용, 알고리즘_스터디_참가자들, 알고리즘_스터디_태그,
            LocalDateTime.now(), null, null,
            LocalDate.now().plusMonths(1), null);

    public static Study 알고리즘_스터디(final Long ownerId, final Set<Long> participants) {
        return new Study(알고리즘_스터디_내용, new Participants(ownerId, participants), 알고리즘_스터디_태그,
                LocalDateTime.now(), null, null,
                LocalDate.now().plusMonths(1), null);
    }
    ...
    public static final Study 리눅스_스터디 = new Study(리눅스_스터디_내용, 리눅스_스터디_참가자들, 리눅스_스터디_태그,
            LocalDateTime.now(), null, LocalDate.now(), LocalDate.now().plusMonths(1),
            LocalDate.now().plusMonths(2));

    public static Study 리눅스_스터디(final Long ownerId, final Set<Long> participants) {
        return new Study(리눅스_스터디_내용, new Participants(ownerId, participants), 리눅스_스터디_태그,
                LocalDateTime.now(), null, LocalDate.now(), LocalDate.now().plusMonths(1),
                LocalDate.now().plusMonths(2));
    }
    ...
    public static Study OS_스터디(final Long ownerId, final Set<Long> participants) {
        return new Study(OS_스터디_내용, new Participants(ownerId, participants), OS_스터디_태그, LocalDateTime.now(),
                10, LocalDate.now(), LocalDate.now().plusMonths(1), LocalDate.now().plusMonths(2));
    }

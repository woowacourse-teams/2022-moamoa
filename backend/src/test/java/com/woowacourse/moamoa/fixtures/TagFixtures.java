...
public class TagFixtures {
    ...
    public static final TagData 자바_태그 = new TagData(자바_태그_아이디, 자바_태그명, 자바_태그_설명, CategoryFixtures.SUBJECT_응답);
    ...
    public static final TagData 우테코4기_태그 = new TagData(우테코4기_태그_아이디, 우테코4기_태그명, 우테코4기_태그_설명, CategoryFixtures.GENERATION_응답);
    ...
    public static final TagData BE_태그 = new TagData(BE_태그_아이디, BE_태그명, BE_태그_설명, CategoryFixtures.AREA_응답);
    ...
    public static final TagData FE_태그 = new TagData(FE_태그_아이디, FE_태그명, FE_태그_설명, CategoryFixtures.AREA_응답);
    ...
    public static final TagData 리액트_태그 = new TagData(리액트_태그_아이디, 리액트_태그명, 리액트_태그_설명, CategoryFixtures.SUBJECT_응답);

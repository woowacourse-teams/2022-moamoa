...
class StudyParticipantControllerTest {
    ...
    private AsynchronousParticipantService asynchronousParticipantService;
    ...
    @BeforeEach
    void initDataBase() {
        asynchronousParticipantService = new AsynchronousParticipantService(memberRepository, studyRepository, new DateTimeSystem());
        studyParticipantService = new StudyParticipantService(asynchronousParticipantService);
    ...
    void participateStudy() {
        ...
        final StudyParticipantController sut = new StudyParticipantController(studyParticipantService, asyncService);

...
import com.woowacourse.acceptance.document.NoticeArticleDocument;
...
public class NoticeArticleRelatedSteps extends Steps<NoticeArticleRelatedSteps, NoticeArticleDocument> {

    private final String token;
    private final Long studyId;

    NoticeArticleRelatedSteps(final String token, final Long studyId) {
        this.token = token;
    ...
    public Long 작성한다(final String title, final String content) {
        try {
            final String location = spec.log().all()
                    ...
                    .body(new ArticleRequest(title, content))
    ...
    public void 수정한다(final Long articleId, final ArticleRequest request) {

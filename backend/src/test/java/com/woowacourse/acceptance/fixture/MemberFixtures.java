...
public class MemberFixtures {
    ...
    public static final GithubProfileResponse 짱구_깃허브_프로필 =
            new GithubProfileResponse(짱구_깃허브_ID, 짱구_이름, 짱구_이미지_URL, 짱구_프로필_URL);

    public static final GithubProfileResponse 그린론_깃허브_프로필 =
            new GithubProfileResponse(그린론_깃허브_ID, 그린론_이름, 그린론_이미지_URL, 그린론_프로필_URL);

    public static final GithubProfileResponse 디우_깃허브_프로필 =
            new GithubProfileResponse(디우_깃허브_ID, 디우_이름, 디우_이미지_URL, 디우_프로필_URL);

    public static final GithubProfileResponse 베루스_깃허브_프로필 =
            new GithubProfileResponse(베루스_깃허브_ID, 베루스_이름, 베루스_이미지_URL, 베루스_프로필_URL);
}

...
export type HeadProps = Pick<StudyDetail, 'title' | 'recruitmentStatus' | 'startDate' | 'endDate' | 'excerpt' | 'tags'>;

const Head: React.FC<HeadProps> = ({ title, recruitmentStatus, startDate, endDate, excerpt, tags }) => {
  return (
    <S.Head>
      <S.TitleContainer>
